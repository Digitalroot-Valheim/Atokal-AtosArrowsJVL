...
{
    public class StoneArrowPrefab : PrefabConfig
    {
        public StoneArrowPrefab() : base("StoneArrow", "StoneArrow_bundle")
        {
        ...
        public override void Register()
        {
            ...
            // info
            item.m_itemData.m_shared.m_name = "Stone Arrow";
            item.m_itemData.m_shared.m_description = "A crude arrow with a blunted stone tip. Good for bonking something from a distance.";
            // general
